  ...
  public UserDetailsService userDetailsService() {
    ...
    protected void configure(HttpSecurity http) throws Exception {
      ...
      http.csrf().disable().authorizeRequests()
              ...
              .antMatchers("/viewOrder/**").hasAnyAuthority("ADMIN","USER")
              .antMatchers("/viewOrder/byCriteria/**").hasAnyAuthority("ADMIN","USER")
              .antMatchers("/viewAllSales/**").hasAnyAuthority("ADMIN")
              .antMatchers("/viewMaxSales/**").hasAnyAuthority("ADMIN")
              .antMatchers("/viewYearlySales/**").hasAnyAuthority("ADMIN")
